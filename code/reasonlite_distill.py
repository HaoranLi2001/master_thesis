...
if __name__ == '__main__':
    ...
    args = TrainingArguments(output_dir='./results_0324_exp15', 
                            num_train_epochs=10, 
                            do_train=True, 
    ...
    train_dataset = SFTDataset('OPR_5k_10_QWEN14B.json', tokenizer=tokenizer, max_seq_len=4096)
    val_dataset = SFTDataset('OPR_valid_2k.json', tokenizer=tokenizer, max_seq_len=4096)
    ...
    trainer.save_model('./saves_0324_exp15')
    trainer.save_state()
