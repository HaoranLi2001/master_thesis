...
models = [
    ...
    dict(
        # type=HuggingFacewithChatTemplate,
        type=VLLM,
        abbr='qwen2.5-15b-instruct_expb',
#        abbr='llama3.2-3B',
        # path='Haoran22/qwen2.5-3B-distill-Math-Alpaca',
        # path='/home/ha5083li/Downloads/0503_q25_15b',
        path='/mimer/NOBACKUP/groups/naiss2026-4-815/HaoranLi/model_0509_re/expb',
...
work_dir = "outputs/week15-gsm-val/0509_expb_prompt1_1024"
