...
models = [
    ...
    dict(
        # type=HuggingFacewithChatTemplate,
        type=VLLM,
        abbr='qwen2.5-05b-instruct_expb',
#        abbr='llama3.2-3B',
        # path='Haoran22/qwen2.5-3B-distill-Math-Alpaca',
        # path='/cephyr/users/haoranl/Alvis/Downloads/qwen25_15b_0503',
        path='/mimer/NOBACKUP/groups/naiss2026-4-815/HaoranLi/q05b_model_re/expb2',
...
work_dir = "outputs/week15-q05b_math_prompt1/0509_expb"
