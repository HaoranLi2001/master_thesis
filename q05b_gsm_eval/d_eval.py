...
'''),
    ...
    inferencer=dict(type=GenInferencer, max_out_len=max_token))
...
models = [
    ...
    dict(
        # type=HuggingFacewithChatTemplate,
        type=VLLM,
        abbr='qwen2.5-15b-instruct_expd',
#        abbr='llama3.2-3B',
        # path='Haoran22/qwen2.5-3B-distill-Math-Alpaca',
        # path='/home/ha5083li/Downloads/0503_q25_15b',
        path='/mimer/NOBACKUP/groups/naiss2026-4-815/HaoranLi/q05b_model_re/expd_200',
...
work_dir = "outputs/week14-q05b_gsm/0509_expd_ep200_prompt1_re"
