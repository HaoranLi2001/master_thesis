...
models = [
    ...
    dict(
        # type=HuggingFacewithChatTemplate,
        type=VLLM,
        abbr='qwen2.5-05b-instruct_expa',
#        abbr='llama3.2-3B',
        # path='Haoran22/qwen2.5-3B-distill-Math-Alpaca',
        # path='/home/ha5083li/Downloads/0503_q25_15b',
        path='/mimer/NOBACKUP/groups/naiss2026-4-815/HaoranLi/q05b_model_re/expa',
...
work_dir = "outputs/week14-q05b_gsm/0509_expa_prompt1"
